...
const images = [
  ...
  { src: other_6, alt: 'Architecture/Design' },
    ...
    return (  
        <div className="">
                <div className="bg-slate-300 text-gray-500 pb-6">
                    <div className=" text-center mt-[5vh] border-2">
                    ...
                    <div className=" cards  flex-col md:flex-row items-center md:flex ">
                        <Card
                            imageSrc={im1}
                    ...
                    <div className=" border-1 border-none rounded-sm text-md text-zinc-200 bg-blue-500 p-5 m-5 mt-1 mb-0 grid grid-rows-1 md:grid-cols-2 h-full gap-6 ">
                            ...
                            <div className="left shadow-inner text-md">
                                        <h2 className="text-zinc-200"> Découvrez les projets déjà réalisés et <span className="text-zinc-50 font-bold text-xl">trouvez la bonne idée </span> </h2>
                                ...
                                <button className="font-bold border-1  bg-blue-900 p-3 ml-[25%] hover:border-blue-50 hover:bg-zinc-200 hover:text-blue-900">Trouvez un Plan </button>
                            </div>
                            <div className="right">
